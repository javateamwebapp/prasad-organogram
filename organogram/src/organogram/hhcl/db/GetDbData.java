...
public static synchronized ResultSet getBasic(String qry, String KeyColumn,ResultSet rs,Connection con) throws SQLException{
...
public static synchronized ResultSet FetchData(String qry, String KeyColumn,ResultSet rs,Connection con) throws SQLException{
	    stmt = con.createStatement();
	    rs = stmt.executeQuery(qry);
		return  rs;	
 }
public static synchronized ResultSet FetchData_Emp_DOB(String qry, String KeyColumn,ResultSet rs,Connection con) throws SQLException{
    stmt = con.createStatement();
    rs = stmt.executeQuery(qry);
	return  rs;	
}
public static  synchronized ResultSet FetchData_Emp_DOJ(String qry, String KeyColumn,ResultSet rs,Connection con) throws SQLException{
    stmt = con.createStatement();
    rs = stmt.executeQuery(qry);
	return  rs;	
}
public static synchronized ResultSet FetchDataPrepare(PreparedStatement ps, String KeyColumn,ResultSet rs,Connection con) throws SQLException{
    rs = ps.executeQuery();
	return  rs;	
}
